...
sudoku6(Puzzle, Solution) :- 
    ...
    valid([Row1, Row2, Row3, Row4, Row5, Row6, Col1, Col2, Col3, Col4, Col5, Col6, Square1, Square2, Square3, Square4, Square5, Square6]),
    write(Row1), nl, write(Row2), nl, write(Row3), nl, write(Row4), nl, write(Row5), nl, write(Row6).